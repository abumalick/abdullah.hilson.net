...
pubDatetime: 2025-07-05T08:03:00Z
title: My Essential Developer and Productivity Toolkit
postSlug: tools
tags:
  - tools
  - productivity
...
- [Google Docs](https://docs.google.com/) - An online word processor for collaborative document editing.
- [LibreOffice](https://www.libreoffice.org/) - A free and open-source office suite for document editing.
...
- [Mistral](https://mistral.ai/) - A versatile and efficient AI assistant, specializing in language and code generation.

## Meetings & Collaboration

- [Zoom](https://zoom.us/) - A video conferencing tool for meetings and webinars.
- [Google Meet](https://meet.google.com/) - Secure video conferencing for team collaboration and online meetings.
...
- [Figma](https://www.figma.com/) - A collaborative design tool for UI/UX design.
- [Affinity Designer](https://affinity.serif.com/en-us/designer/) - A vector graphics editor for professional design work.
- [Affinity Photo](https://affinity.serif.com/en-us/photo/) - A professional photo editing software.
- [Nucleo](https://nucleoapp.com/) - An icon library and management tool for designers.

## News & Reading

- [NetNewsWire](https://netnewswire.com/) - An RSS reader for staying updated with news and blogs.
- [Syft](https://syft.ai/) - An AI-powered news aggregator that curates content based on your interests.
